function [ X_estimated_blip,E_matched_filter_blip, varargout] = blipAlgSpiral( Y_spiral_noised,sampling_locations_spiral,cell_dimensions,D,N,L,X )
% 08/05/2019 save memory by using find_E_SaveMem.m --spf
...
%     E_matched_filter_blip=find_E_fast(X_estimated_blip,D);% very memory-consuming
    
    E_matched_filter_blip=find_E_SaveMem(X_estimated_blip,D, 1); % memory efficient
