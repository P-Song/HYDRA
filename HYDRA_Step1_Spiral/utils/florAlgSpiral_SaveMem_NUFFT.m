function [ X_nuc_spiral] = florAlgSpiral( Y,sampling_locations_spiral,cell_dimensions,D,N,L,X,th )
...
base = orth(D.');
%NUFFT:
X_nuc_spiral = minNucSpiral_NUFFT( N,Y,sampling_locations_spiral,cell_dimensions,base.' );
% %SPURS:
