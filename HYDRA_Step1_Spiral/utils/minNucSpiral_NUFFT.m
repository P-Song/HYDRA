function [ X ] = minNucSpiral( N,Y,sampling_locations,cell_dimensions,D,X_real,th )

% 14/04/2019 use NUFFT instead of SPURS, but there is no function
% ifft_mats_non_uniform_fessler.
